...
const Skills = () => {
  return (
    ...
    >
      <div className="w-full lgl:w-1/2 px-8">
        <div className="py-12 font-titleFont flex flex-col gap-4 px-1">
          <p className="text-sm text-amber-400 tracking-[4px] uppercase">
            Skills
          </p>
          <h2 className="text-3xl md:text-3xl font-bold">Key Skills</h2>
        </div>
          ...
          <div className="overflow-x-hidden">
            ...
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              <motion.span
                ...
                className="w-[90%] h-full bg-amber-400 via-pink-500 to-red-500 rounded-md relative"
              >
          ...
          <div className="overflow-x-hidden">
            ...
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              <motion.span
                ...
                animate={{ x: 0, opacity: 1 }}
                transition={{ duration: 0.5, delay: 0.5 }}
                className="w-[80%] h-full bg-amber-400 via-pink-500 to-red-500 rounded-md relative"
              >
          ...
          <div className="overflow-x-hidden">
            ...
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              <motion.span
                ...
                animate={{ x: 0, opacity: 1 }}
                transition={{ duration: 0.5, delay: 0.5 }}
                className="w-[85%] h-full bg-amber-400 via-pink-500 to-red-500 rounded-md relative"
              >
          ...
          <div className="overflow-x-hidden">
            ...
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              <motion.span
                ...
                animate={{ x: 0, opacity: 1 }}
                transition={{ duration: 0.5, delay: 0.5 }}
                className="w-[75%] h-full bg-amber-400 via-pink-500 to-red-500 rounded-md relative"
              >
